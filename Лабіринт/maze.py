...
lose = font.render("YOU LOSE!", True, (240,35,33))
...
# стіни
w1 = Wall(158, 173, 123, 100, 20, 450, 10) # жовта
w2 = Wall(158, 173, 123, 100, 480, 350, 10)
w3 = Wall(158, 173, 123, 100, 10, 10, 380) 




w4 = Wall(158, 173, 123, 200, 140, 340, 10)
w5 = Wall(158, 173, 123, 200, 140, 10, 300) 
